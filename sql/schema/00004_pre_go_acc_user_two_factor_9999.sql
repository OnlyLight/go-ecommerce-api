...
CREATE TABLE IF NOT EXISTS `pre_go_acc_user_two_factor_9999` (
  ...
  `two_factor_created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT 'Record creation time',
  `two_factor_updated_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Record update time',
