...
CREATE TABLE IF NOT EXISTS `go_crm_user` (
  ...
  `usr_created_at` int(11) NOT NULL DEFAULT '0' COMMENT 'Created At',
  `usr_updated_at` int(11) NOT NULL DEFAULT '0' COMMENT 'Updated At',
  `usr_create_ip_at` varchar(12) NOT NULL DEFAULT '' COMMENT 'Create IP At',
  `usr_last_login_at` int(11) NOT NULL DEFAULT '0' COMMENT 'Last Login At',
  ...
  `usr_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Status 1:Enable 0:Disabled -1:Deleted',
  PRIMARY KEY (`usr_id`),
